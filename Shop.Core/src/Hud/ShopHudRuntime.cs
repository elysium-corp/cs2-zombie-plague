...
{
    internal const string Layout = "panorama/layout/custom_game/elysium_shop_v4_r7.vxml_c";
    internal const string Style = "panorama/styles/custom_game/elysium_shop_v4_r7.vcss_c";
