...
{
    internal const string Layout = "panorama/layout/custom_game/elysium_shop_v1.vxml_c";
    internal const string Style = "panorama/styles/custom_game/elysium_shop_v1.vcss_c";
