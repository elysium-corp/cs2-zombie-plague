...
public sealed class Freeze(ISwiftlyCore core, Action<IEffect> callback, IPlayer? caster, IPlayer target, FreezeSettings? settings) : BaseEffect(core, callback, caster, target)
{
