...
public sealed class ShopHudAppearanceTests
{
    ...
    public void AllCmsOptionsHaveMatchingPanoramaClassesAndDefaults()
    {
        ...
        var css = File.ReadAllText(Path.Combine(AppContext.BaseDirectory, "Fixtures", "elysium_shop_v4_r6.css"));
    ...
    public void WebPreviewIsGeneratedFromCurrentGameResourcesAndSpecification()
    {
        ...
        var source = File.ReadAllText(Path.Combine(directory, "elysium_shop_v4_r6.xml"))
            + File.ReadAllText(Path.Combine(directory, "elysium_shop_v4_r6.css"));
