...
Версия `0.4.0` хранит в PostgreSQL огнестрельное оружие, пять встроенных гранат,
...
справочника. Каталоги обновляются при запуске плагина и один раз при каждой
