...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("CustomEquipment.Database.Entities.EquipmentShopCategoryEntity", b =>
        {
            ...
            {
                t.HasCheckConstraint("CK_shop_categories_localization_keys", "display_name_key ~ '^[A-Z0-9][A-Za-z0-9]*(\\.[A-Z0-9][A-Za-z0-9]*)*$' AND (description_key IS NULL OR description_key ~ '^[A-Z0-9][A-Za-z0-9]*(\\.[A-Z0-9][A-Za-z0-9]*)*$')");
        ...
        modelBuilder.Entity("CustomEquipment.Database.Entities.EquipmentShopListingEntity", b =>
        {
            ...
            {
                t.HasCheckConstraint("CK_shop_listings_description_key", "description_key IS NULL OR description_key ~ '^[A-Z0-9][A-Za-z0-9]*(\\.[A-Z0-9][A-Za-z0-9]*)*$'");
        ...
        modelBuilder.Entity("CustomEquipment.Database.Entities.EquipmentShopProductEntity", b =>
        {
            ...
            {
                t.HasCheckConstraint("CK_shop_products_display_name_key", "display_name_key ~ '^[A-Z0-9][A-Za-z0-9]*(\\.[A-Z0-9][A-Za-z0-9]*)*$'");
            });
        });
        ...
        modelBuilder.Entity("CustomEquipment.Database.Entities.EquipmentShopSettingsEntity", b =>
        {
            ...
            {
                t.HasCheckConstraint("CK_shop_settings_display_name_key", "display_name_key ~ '^[A-Z0-9][A-Za-z0-9]*(\\.[A-Z0-9][A-Za-z0-9]*)*$'");
        ...
        modelBuilder.Entity("CustomEquipment.Database.Entities.GameplayItemEntity", b =>
        {
            ...
            b.ToTable("gameplay_items", "custom_equipment", t =>
            {
                ...
                t.HasCheckConstraint("CK_gameplay_items_display_name_key", "display_name_key ~ '^[A-Z0-9][A-Za-z0-9]*(\\.[A-Z0-9][A-Za-z0-9]*)*$'");
