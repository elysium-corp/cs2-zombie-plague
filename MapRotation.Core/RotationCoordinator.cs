    ...
    MapEngineAdapter maps, TimeProvider clock, RotationText text, RotationHudPreferences preferences) : IDisposable
{
    ...
    private HudMenu NominationMenu(IPlayer player) => new(NominationChannel, Text(player, "NominationTitle"), Text(player, "NominationSubtitle"),
        ...
        { StyleClass = "MapRotation", VerticalGap = _hudConfiguration.VerticalGap, HorizontalGap = _hudConfiguration.HorizontalGap, ThemeClasses = _hudConfiguration.ThemeClasses, Presentation = preferences.Get(player), SettingsText = SettingsText(player), ShowBrand = true,
    ...
    private HudMenu VoteMenu(IPlayer player, VoteState vote, HudMenuView view = HudMenuView.List) => new(VoteChannel,
        ...
        {
            StyleClass = "MapRotation", VerticalGap = _hudConfiguration.VerticalGap, HorizontalGap = _hudConfiguration.HorizontalGap, ThemeClasses = _hudConfiguration.ThemeClasses, View = view, Presentation = preferences.Get(player), SettingsText = SettingsText(player),
    ...
    private HudMenu ResultMenu(IPlayer player, ResultHud result)
    {
        ...
        {
            StyleClass = "MapRotation", VerticalGap = _hudConfiguration.VerticalGap, HorizontalGap = _hudConfiguration.HorizontalGap, ThemeClasses = _hudConfiguration.ThemeClasses, View = HudMenuView.Result, Presentation = preferences.Get(player),
