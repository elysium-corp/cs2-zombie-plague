...
internal static class BuiltInLocalizationEntries
{
    public static Dictionary<string, Dictionary<string, string>> Create() =>
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Equipment.Item.custom_equipment.ajm.Name"] = RuEn("CZ75 Ajm", "CZ75 Ajm"),
            ["Equipment.Item.custom_equipment.blackline.Name"] = RuEn("MP9 Blackline", "MP9 Blackline"),
            ["Equipment.Item.custom_equipment.elite.Name"] = RuEn("SSG Elite", "SSG Elite"),
            ["Equipment.Item.custom_equipment.frostbyte.Name"] = RuEn("MP7 Frostbyte", "MP7 Frostbyte"),
            ["Equipment.Item.custom_equipment.lava.Name"] = RuEn("AK47 Lava", "AK47 Lava"),
            ["Equipment.Item.custom_equipment.omega.Name"] = RuEn("Omega Shotgun", "Omega Shotgun"),
            ["Equipment.Item.custom_equipment.reactorleak.Name"] = RuEn("UMP45 ReactorLeak", "UMP45 ReactorLeak"),
            ["Equipment.Item.custom_equipment.reaver.Name"] = RuEn("Deagle Reaver", "Deagle Reaver"),
            ["Equipment.Item.custom_equipment.x3.Name"] = RuEn("M4A1-S X3", "M4A1-S X3"),
