...
internal class ZClassMenu(ISwiftlyCore core)
{
    private readonly Dictionary<int, IZClass> _playersZClass = new();
    ...
    public IZClass GetPlayerZClass(int playerId)
    {
        if (_playersZClass.TryGetValue(playerId, out var zClass))
        {
            return zClass;
        }
